...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit (formName) {
        // this.form.startTime=moment(this).format("YYYY-MM-DD'T'HH:mm:ss")
        // this.form.endTime=moment(this).format("YYYY-MM-DD'T'HH:mm:ss")
        // this.form.canceledTime=moment(this).format("YYYY-MM-DD'T'HH:mm:ss")
        // this.form.reservationTime=moment(this).format("YYYY-MM-DD'T'HH:mm:ss")
